      ...
      >
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            name="phone"
            label="Phone number"
            placeholder=" ex: (+91) 123-456-7890"
          />
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="ex: Peanuts, Sand, Oil"
          />
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="ex: Heart disease, Cancer"
          />
        ...
        <CustomFormField
          ...
          placeholder="ex: Voter ID card, Aadhaar card"
        >
